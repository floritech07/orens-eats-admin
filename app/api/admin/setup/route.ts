...
export async function GET(req: Request) {
  // Simple protection: only run if no superadmin exists or if a secret key is provided
  ...
  try {
    ...
    // 3. Create initial profiles for the cashier account
    ...
    // 4. Catégories et Produits (Seeding)
    ...
    return NextResponse.json({
      success: true,
      message: "Comptes et menu initialisés avec succès",
      credentials: {
        superadmin: "laurelbonou@gmail.com",
        cashier_account: "cotedorens@gmail.com",
        default_password: "Orens@2026",
        default_pin: "1234"
      }
    });
  } catch (error: any) {
